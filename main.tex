...
if brought into other projects.
...
project. The \emph{README.md} file in the root directory of the repository
...
available in the \emph{gh-pages} git development branch and is hosted using
GitHub Pages.
