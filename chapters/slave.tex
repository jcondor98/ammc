...
\begin{table}[hb]
  \begin{tabularx}{\textwidth}{c X X}
    ...
    dcmotor &
      Contains stuff to directly manipulate dc motors, including the PID
      controller, PWM waves generation and speed manipulation routines &
    ...
    dcmotor\_pid &
      Contains the software PID controller routines &
    ...
    twi &
      Contains the I2C/TWI layer which underlies the communication between
      master and slaves &
      \texttt{include/twi.h},
      \texttt{source/twi.c} \\
    \bottomrule
...
\begin{figure}[hbp]
\begin{centering}
  \includegraphics[scale=0.6]{slave-schematics-grayscale}
